...
2. **Complex Analysis**  
   - *Complex Analysis* by Lars Ahlfors  
     - Covers: Holomorphic functions, Cauchy’s theorem, residue calculus, conformal mappings.  
...
1. **Quantum Mechanics**  
   - *Introduction to Quantum Mechanics* by David J. Griffiths and Darrell F. Schroeter  
     - Covers: Schrödinger equation, angular momentum, spin, perturbation theory.  
